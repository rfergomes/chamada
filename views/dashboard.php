	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
		<div class="card mb-3">
			<div class="card-header">
				<h3><i class="fa fa-line-chart"></i> SESSÃO</h3>
	...
	$('document').ready(function() {
		$.ajax({
			...
			success: function(data) {
				...
				console.log(mes, presenca, ausencia);
				grafico(mes, presenca, ausencia);
			}
		});
	})

	function grafico(mes, presenca, ausencia) {

	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
		...
		<div class="card mb-3">
			...
			<div class="card-header">
				<span class="pull-right"><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_add_user"><i class="fa fa-user-plus" aria-hidden="true"></i> Novo Usuário</button></span>
				<?php include("modals/modal_add_user.php"); ?>
				<h3><i class="fa fa-user"></i> Lista de Usuários (<?php echo $numb_users; ?> usuários)</h3>
			</div>
			<!-- end card-header -->
			...
			<div class="card-body">
				...
				?>
					...
					Página <strong><?php echo $pagenum; ?></strong> de <strong><?php echo $last; ?></strong>
					<div class="mb-2"></div>
					...
					<ul class="pagination">
						...
						if ($pagenum == 1) {
							...
							echo '<li class="page-item"> <a class="page-link" href="account.php?page=pro-users&pagenum=1"><strong>Primeira Página</strong></a></li>';
							echo ' ';
							$previous = $pagenum - 1;
						...
						if ($pagenum == $last) {
							...
							echo ' ';
							echo '<li class="page-item"><a class="page-link" href="account.php?page=pro-users&pagenum=' . $last . '"><strong>Última Página</strong></a></li>';
						}
						?>
					</ul>

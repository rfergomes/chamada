										...
										?>
											<tr role="row" class="odd">
												...
												<td class="text-center">
													<div class="row">
														<div class="col">
															<a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-tt="tooltip" data-title="Alterar" data-target="#modal_edit_event_<?= $id_evento; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
														</div>
														<?php include("modals/modal_edit_event.php"); ?>
														<div class="col">
															<a href="javascript:deleteRecord_<?= $id_evento; ?>('<?= $id_evento; ?>');" class="btn btn-danger btn-sm" data-placement="top" data-toggle="tooltip" data-title="Excluir"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
														...
														<div class="col">
															<a href="account.php?page=participantes&id=<?= $id_evento ?>" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Participantes"><i class="fa fa-users" aria-hidden="true"></i></a>
														</div>
													</div>
												</td>
											</tr>
